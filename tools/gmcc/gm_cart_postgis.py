...
class PostgisImporter:
    ...
    def __init__(self, schema, base, mapping, cod_field, ndd, forceGeom, forcePolygon, forceClose, save_src):
        self.schema = schema
        self.base = base
    ...
    def get_feature(self, layer, fields, feature, cod=None, src=None, enforce=True, support_ref=True):
        ...
        if self.save_src:
            if cod:
                ...
                out_fields.append(
                    '\'' + feature['data'].GetFieldAsString(self.cod_field) + '\'')
            if src:
    ...
    def save_datasource(self, path):
        try:
            ...
            print('Erro a guardar ficheiro \'' + path + '\': ' + str(e))
    ...
    def save_remaining(self, path):
        try:
            ...
            print('Erro a guardar ficheiro de remaining: \'' + str(e) + '\'')
    ...
    def save_errors(self, path):
        ...
        try:
            with open(path, "w", encoding='utf-8') as error_sql_file:
                ...
                for f in self.base['_import_error'].get_elements():
                    ...
                    if f['data'].IsFieldSet(self.cod_field):
                        out.append(
                            '\'' + f['data'].GetFieldAsString(self.cod_field) + '\'')
                    else:
                        out.append('\'\'')
                    out.append('\'' + f['src'] + '\'')
            ...
            print('Erro a guardar ficheiro de erros: \'' + str(e) + '\'')
