displayList = {
    ...
    'intersecoes_2d': {'index': 350, 'alias': 'Interseções 2D', 'name': '[03] ALTIMETRIA', 'geom': ['POINTZ']},
    ...
    'descontinuidades': {'index': 570, 'alias': 'Descontinuidade', 'name': '[05] TRANSPORTES', 'geom': ['POINTZ']},
